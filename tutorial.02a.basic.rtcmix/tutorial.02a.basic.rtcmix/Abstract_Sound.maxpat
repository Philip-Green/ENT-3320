...
, 			{
				"box" : 				{
					...
					"save" : [ "#N", "rtcmix~", 2, 0, ";", "#X", "restore", 0, 467, 467, "infile = \"C:\\Users\\kingk\\OneDrive\\Documents\\fran-freesound-watersplahing.wav\"\r\nrtinput(infile) \r\nsfdur = filedur(infile)\r\n\r\n//STEREO(outsk=0.0, insk=0.0, dur=sfdur, amp=1.0, 1.0, 0.0)\r\nenv = maketable(\"line\", 1000, 0, 0, 3.5,1, 7,0)\r\nwavetable = maketable(\"wave\", 1000, \"sine\")\r\nguide = maketable(\"line\", \"nonorm\", 1000, 0,1, 7,0)\r\n\r\nFMINST(outsk=0.0, dur=sfdur, AMP=30000 * env, CARFREQ=cpspch(8.00), MODFREQ=179, LOWINDEX=0, HIGHINDEX=10, PAN=0.5, wavetable, guide)", ";" ],
					"text" : "rtcmix~ 2"
				}
